 ...
 */
public class ExposicaoEstadoConflitosAlterados implements ExposicaoEstado, Serializable {

    private Exposicao exposicao;

    public ExposicaoEstadoConflitosAlterados(Exposicao exposicao) {
    ...
    public boolean setCandidaturasAtribuidas() {
        if (valida()) {
            exposicao.setEstadoExp(new ExposicaoEstadoCandidaturasAtribuidas(exposicao));
            return true;
        }
        return false;
    }
