 ...
 * @author Grupo 18
 */
public class ExposicaoEstadoCandidaturasAvaliadas implements ExposicaoEstado, Serializable {

    private Exposicao exposicao;

    public ExposicaoEstadoCandidaturasAvaliadas(Exposicao exposicao) {
    ...
    public boolean setCandidaturasDecididas() {
        if (valida()) {
            exposicao.setEstadoExp(new ExposicaoEstadoCandidaturasDecididas(exposicao));
            return true;
        }
        return false;
    }
